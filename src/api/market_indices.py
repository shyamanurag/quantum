...
async def get_market_indices():
    ...
    try:
        ...
        indices_data = {
            ...
            "message": "No market data available in crypto-only system"
        }
...
async def get_market_status():
    ...
    try:
        ...
        market_status = {
            ...
            "data_provider": {
                "name": "Binance",
                "status": "CONNECTED" if os.getenv('BINANCE_API_KEY') else "NOT_CONFIGURED",
                "user": os.getenv('BINANCE_API_KEY', 'Not configured')
            }
        }
